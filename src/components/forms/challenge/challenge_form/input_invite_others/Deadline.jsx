...
const Deadline = ({ challengeAnnouncement, setChallengeAnnouncement, ...args }) => {
   ...
   return (
      <FormGroup>
         ...
         <Input type='date' id='announcementDeadline' value={challengeAnnouncement.announcementEndsOn} min={currentDate} max={add5months} onChange={e => setChallengeAnnouncement(prv => ({...prv, announcementEndsOn: e.target.value}))} required/>
      </FormGroup>
   )
}
