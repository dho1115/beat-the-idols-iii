...
const ChallengeFormComponent = () => {
   const [challengeDetails, setChallengeDetails] = useState({ id: null, posted: null, title: '', description: '', inviteOthers: '', deadline: "0000-00-00", challengeCoverType: '', challengeCoverImage: '', challengeEndsCondition: "", challengeExpires: "0000-00-00", challengeVideos: [] /* each video should have a record prop */, howChallengeEnds: '' });
